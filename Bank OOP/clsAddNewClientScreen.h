...
public:
    static void ShowAddNewClientScreen() {
        ...
        while (clsBankClient::IsClientExist(AccountNumber)) {
            cout << setw(37) << left << "" << "Your Account Number is Aready Used , Please enter another one : ";
            AccountNumber = clsInputValidate::ReadString();
            cout << endl;
        }
        ...
        if (Acces == 'Y' || Acces == 'y')
        {
            ...
            case clsBankClient::svFaildAccountNumberExists:
                cout << setw(37) << left << "" << "Error account was not saved because account number is used!\n";
                break;
            }
        }
    }
